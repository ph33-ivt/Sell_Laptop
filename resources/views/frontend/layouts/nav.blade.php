        ...
        <div class="categori-style-2">
            <div class="category-heading-2">
                ...
                <div class="category-menu-list">
                    <ul>
                        <li>
                            <a href="#"><img alt="" src="{{asset('img/frontend/icon-img/15.png')}}">Computer & Laptops <i class="pe-7s-angle-right"></i></a>
                            <div class="category-menu-dropdown">
                                ...
                                <div class="mega-banner-img">
                                    <a href="single-product.html">
                                        <img src="{{ asset('img/frontend/banner/18.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <a href="#"><img alt="" src=" {{ asset('img/frontend/icon-img/16.png ')}}">Phone & Tablets <i class="pe-7s-angle-right"></i></a>
                            <div class="category-menu-dropdown">
                        ...
                        <li>
                            <a href="#"><img alt="" src="{{ asset('img/frontend/icon-img/17.png')}}"> Camera & Photos<i class="pe-7s-angle-right"></i></a>
                            <div class="category-menu-dropdown">
...
<div class="slider-area">
    <div class="slider-active owl-carousel">
        <div class="single-slider-4 slider-height-4 bg-img" style="background-image: url( {{ asset('img/frontend/slider/6.jpg') }})">
            <div class="container">
